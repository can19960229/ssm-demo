...
<title>candy-chen后台数据管理系统</title>
<meta name="description" content="candy-chen后台数据管理系统">
<meta name="keywords" content="candy-chen后台数据管理系统">
...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
			...
			<form action="${pageContext.request.contextPath}/product/save.do"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data ">
							<textarea class="form-control" rows="1" placeholder="其他信息"
		...
		<strong>Copyright &copy; 1997-2020 <a
				href="https://blog.csdn.net/qq_35655602">candy-chen测试网站</a>.
